...
public: 
	SlimKingEnemy() {
		static ResourcesManager* resource = ResourcesManager::instance();
		static const ResourcesManager::TexturePool& texture_pool = resource->get_texture_pool();
		static SDL_Texture* tex_slime_king = texture_pool.find(ResID::Tex_SlimeKing)->second;
		static SDL_Texture* tex_slime_king_sketch = texture_pool.find(ResID::Tex_SlimeKingSketch)->second;
